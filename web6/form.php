...
<body>
  ...
  <div class="container">
        <label>Новая таблица admin.</label><br>
        <img src="img/1.png" alt="Image 1">
        <br>
        <label>Требование ввода логина и пароля администратора.</label><br>
        <img src="img/5.jpg" alt="Image 2">
        <br>
        <label>Панель администратора.</label><br>
        <img src="img/4.png" alt="Image 3">
        <br>
        <label>Удаление пользователя (до и после).</label><br>
        <img src="img/2.png" alt="Image 4">
        <img src="img/3.png" alt="Image 5">
        <br>
        <label>Произошёл пересчёт статистики после изменений данных.</label><br>
